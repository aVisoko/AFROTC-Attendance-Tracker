...
{
    $query = "DELETE FROM af_info.comments WHERE comments.ID = 1";
}

if($submission == "Delete Comment 2")
{
    $query = "DELETE FROM af_info.comments WHERE comments.ID = 2";
}
if($submission == "Delete Comment 3")
{
    $query = "DELETE FROM af_info.comments WHERE comments.ID = 3";
}
