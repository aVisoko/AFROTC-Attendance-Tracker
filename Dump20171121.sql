...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2017-11-21 22:04:50',NULL),('diagnostics.include_raw','OFF','2017-11-21 22:04:50',NULL),('ps_thread_trx_info.max_length','65535','2017-11-21 22:04:50',NULL),('statement_performance_analyzer.limit','100','2017-11-21 22:04:50',NULL),('statement_performance_analyzer.view',NULL,'2017-11-21 22:04:50',NULL),('statement_truncate_len','64','2017-11-21 22:04:50',NULL);
...
--
-- Current Database: `af_info`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `af_info` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
--
-- Dumping data for table `week_10`
--

LOCK TABLES `week_10` WRITE;
/*!40000 ALTER TABLE `week_10` DISABLE KEYS */;
INSERT INTO `week_10` VALUES ('abradshaw',0,0,0,0),('akessler',1,0,1,1),('amcnair',1,0,0,0),('aparrish',0,0,0,0),('ascott',1,0,1,0),('asites',1,1,0,0),('awands',1,0,1,0),('bdahlgren',1,1,0,1),('bede',1,0,1,0),('bsnider',0,0,1,1),('bstewart',1,0,0,0),('bwhite',1,1,0,1),('cvalelo',1,1,1,0),('cwalrod',1,0,0,0),('dbass',0,1,1,0),('devans',1,1,1,0),('ebrenner',1,1,1,1),('efessler',1,1,0,0),('ekessel',0,0,1,1),('epowell',1,0,0,1),('erachell',1,0,0,1),('gjohnson',0,1,1,0),('gmcafee-myers',0,1,0,1),('gsapienza',0,0,1,0),('hdeaver',0,0,1,1),('hlara',0,1,1,0),('jcallahan',0,0,1,1),('jholm',1,0,1,0),('jjenkins',0,0,1,0),('jkessler',0,0,1,1),('jknifong',0,0,1,0),('jlentz',0,1,1,0),('jpatton',0,0,1,1),('jstovall',0,0,0,0),('kbocanegra',0,0,1,1),('kboyd',0,1,1,1),('kklingensmith',1,0,0,1),('lcanady',0,0,0,1),('ldavis',0,1,1,0),('ljames',1,0,1,1),('lschwarz',1,1,0,0),('mbay',1,1,0,1),('mboley',0,1,0,1),('mdavis',1,1,0,0),('mhatfield',1,1,0,0),('mhodge',1,0,1,1),('mpage',0,1,1,0),('ncorretjer',0,1,0,0),('ndaniel',1,0,0,0),('nrhodes',1,1,1,1),('odonaldson',1,1,0,0),('rbeckerman',0,1,0,1),('rgreen',1,0,1,1),('rmoffett',0,0,0,1),('rtindall',0,0,1,0),('schristy',1,0,0,1),('scrockett',0,0,1,0),('sdudenhoeffer',0,0,1,0),('snyquist',1,1,1,1),('soverby',0,0,0,1),('sscully',1,1,0,1),('stodd',1,0,0,0),('tshaw',1,1,1,1),('vcaballero',0,0,1,1),('zcambron',0,1,1,0),('zmontgomery',0,0,0,0),('﻿jarmington',0,1,0,1);
/*!40000 ALTER TABLE `week_10` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_11`
--

DROP TABLE IF EXISTS `week_11`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_11` (
  `username` varchar(20) NOT NULL,
  `llab` tinyint(1) NOT NULL,
  `tuesday` tinyint(1) NOT NULL,
  `thursday` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `week_11`
--

LOCK TABLES `week_11` WRITE;
/*!40000 ALTER TABLE `week_11` DISABLE KEYS */;
INSERT INTO `week_11` VALUES ('abradshaw',1,0,1,0),('akessler',0,1,1,1),('amcnair',1,0,1,0),('aparrish',1,1,1,1),('ascott',0,1,0,0),('asites',0,1,0,0),('awands',0,1,1,0),('bdahlgren',1,0,1,0),('bede',1,1,1,0),('bsnider',1,1,0,1),('bstewart',1,0,1,1),('bwhite',1,0,1,1),('cvalelo',0,1,0,0),('cwalrod',0,0,0,0),('dbass',1,1,0,1),('devans',0,1,1,0),('ebrenner',0,0,1,1),('efessler',0,0,1,1),('ekessel',0,0,1,0),('epowell',0,1,1,1),('erachell',1,1,1,1),('gjohnson',1,1,0,1),('gmcafee-myers',0,1,1,1),('gsapienza',1,0,0,0),('hdeaver',1,1,1,0),('hlara',1,1,1,1),('jcallahan',0,0,0,1),('jholm',0,0,0,1),('jjenkins',1,1,1,1),('jkessler',1,1,1,0),('jknifong',0,1,1,0),('jlentz',0,1,0,1),('jpatton',0,0,0,0),('jstovall',1,0,0,0),('kbocanegra',1,1,0,0),('kboyd',0,1,1,1),('kklingensmith',1,0,1,1),('lcanady',0,1,1,1),('ldavis',0,1,0,0),('ljames',1,1,0,0),('lschwarz',1,1,0,0),('mbay',1,0,1,1),('mboley',1,1,0,1),('mdavis',0,1,1,1),('mhatfield',1,1,1,0),('mhodge',0,1,0,1),('mpage',1,1,0,0),('ncorretjer',1,1,0,0),('ndaniel',1,0,1,0),('nrhodes',1,1,1,1),('odonaldson',0,0,1,1),('rbeckerman',0,0,0,1),('rgreen',1,0,0,1),('rmoffett',0,0,1,1),('rtindall',0,1,1,1),('schristy',0,1,1,0),('scrockett',1,1,0,0),('sdudenhoeffer',1,0,0,1),('snyquist',1,1,1,1),('soverby',1,0,0,0),('sscully',1,0,0,1),('stodd',0,0,1,0),('tshaw',1,0,0,1),('vcaballero',1,1,1,0),('zcambron',1,0,0,0),('zmontgomery',1,0,1,0),('﻿jarmington',1,1,1,1);
/*!40000 ALTER TABLE `week_11` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_12`
--

DROP TABLE IF EXISTS `week_12`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_12` (
  `username` varchar(20) NOT NULL,
  `llab` tinyint(1) NOT NULL,
  `tuesday` tinyint(1) NOT NULL,
  `thursday` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `week_12`
--

LOCK TABLES `week_12` WRITE;
/*!40000 ALTER TABLE `week_12` DISABLE KEYS */;
INSERT INTO `week_12` VALUES ('abradshaw',0,1,0,1),('akessler',1,0,1,1),('amcnair',1,0,0,0),('aparrish',0,1,1,1),('ascott',1,1,0,0),('asites',1,1,0,1),('awands',1,1,1,1),('bdahlgren',0,0,1,0),('bede',1,1,0,1),('bsnider',0,1,1,1),('bstewart',1,0,0,1),('bwhite',1,1,0,0),('cvalelo',0,0,0,1),('cwalrod',1,0,0,0),('dbass',1,0,0,1),('devans',0,0,0,0),('ebrenner',1,1,0,1),('efessler',0,1,0,0),('ekessel',0,1,1,0),('epowell',1,0,1,0),('erachell',1,0,1,1),('gjohnson',1,0,1,0),('gmcafee-myers',1,0,1,1),('gsapienza',0,1,0,0),('hdeaver',0,0,0,0),('hlara',0,0,1,1),('jcallahan',0,0,1,0),('jholm',0,0,1,1),('jjenkins',0,1,0,0),('jkessler',1,1,0,1),('jknifong',1,1,0,0),('jlentz',0,0,1,1),('jpatton',1,1,0,0),('jstovall',1,1,1,1),('kbocanegra',1,1,1,0),('kboyd',0,0,1,1),('kklingensmith',1,0,1,0),('lcanady',0,1,0,0),('ldavis',1,0,1,1),('ljames',0,1,0,1),('lschwarz',1,1,0,1),('mbay',0,1,1,1),('mboley',1,0,1,1),('mdavis',1,0,0,0),('mhatfield',1,1,0,0),('mhodge',0,0,0,0),('mpage',1,0,1,1),('ncorretjer',0,1,1,0),('ndaniel',0,1,1,0),('nrhodes',1,1,0,1),('odonaldson',1,1,0,0),('rbeckerman',1,0,1,1),('rgreen',0,1,0,0),('rmoffett',0,1,1,1),('rtindall',1,0,1,0),('schristy',1,1,1,1),('scrockett',1,1,0,1),('sdudenhoeffer',0,1,0,1),('snyquist',0,1,1,0),('soverby',0,1,1,0),('sscully',1,0,0,1),('stodd',0,0,0,1),('tshaw',0,1,0,0),('vcaballero',1,1,1,0),('zcambron',0,1,0,1),('zmontgomery',0,1,0,1),('﻿jarmington',0,1,1,1);
/*!40000 ALTER TABLE `week_12` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_13`
--

DROP TABLE IF EXISTS `week_13`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_13` (
  `username` varchar(20) NOT NULL,
  `llab` tinyint(1) NOT NULL,
  `tuesday` tinyint(1) NOT NULL,
  `thursday` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `week_13`
--

LOCK TABLES `week_13` WRITE;
/*!40000 ALTER TABLE `week_13` DISABLE KEYS */;
INSERT INTO `week_13` VALUES ('abradshaw',1,1,1,1),('akessler',0,1,0,0),('amcnair',0,0,1,0),('aparrish',0,1,1,1),('ascott',1,0,1,1),('asites',1,0,1,0),('awands',0,0,1,1),('bdahlgren',0,1,0,1),('bede',0,1,0,1),('bsnider',0,1,0,1),('bstewart',0,0,1,0),('bwhite',0,0,1,0),('cvalelo',0,0,1,1),('cwalrod',0,0,0,1),('dbass',0,0,1,1),('devans',1,0,0,1),('ebrenner',0,1,1,1),('efessler',1,0,1,0),('ekessel',0,0,1,0),('epowell',0,0,1,0),('erachell',0,0,0,0),('gjohnson',1,0,1,1),('gmcafee-myers',0,0,0,0),('gsapienza',0,0,0,0),('hdeaver',0,0,1,0),('hlara',0,1,1,0),('jcallahan',1,1,1,1),('jholm',0,1,1,1),('jjenkins',0,0,0,1),('jkessler',0,1,1,0),('jknifong',1,0,1,0),('jlentz',0,1,1,1),('jpatton',0,0,1,0),('jstovall',0,1,1,1),('kbocanegra',1,0,0,1),('kboyd',1,0,0,1),('kklingensmith',1,0,0,0),('lcanady',1,1,0,1),('ldavis',1,1,0,0),('ljames',0,1,1,0),('lschwarz',1,1,0,0),('mbay',0,0,0,0),('mboley',1,1,1,0),('mdavis',0,1,0,0),('mhatfield',0,1,0,1),('mhodge',1,0,0,1),('mpage',0,0,0,0),('ncorretjer',0,1,0,1),('ndaniel',1,1,0,0),('nrhodes',1,0,0,0),('odonaldson',0,1,1,0),('rbeckerman',0,1,1,1),('rgreen',0,0,1,1),('rmoffett',0,1,0,0),('rtindall',1,1,0,1),('schristy',1,0,1,1),('scrockett',0,1,1,1),('sdudenhoeffer',0,0,1,1),('snyquist',1,1,0,1),('soverby',0,1,0,1),('sscully',0,1,0,1),('stodd',1,1,0,0),('tshaw',0,0,1,1),('vcaballero',0,0,0,1),('zcambron',1,0,1,0),('zmontgomery',1,0,0,0),('﻿jarmington',1,0,0,0);
/*!40000 ALTER TABLE `week_13` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_14`
--

DROP TABLE IF EXISTS `week_14`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_14` (
  `username` varchar(20) NOT NULL,
  `llab` tinyint(1) NOT NULL,
  `tuesday` tinyint(1) NOT NULL,
  `thursday` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `week_14`
--

LOCK TABLES `week_14` WRITE;
/*!40000 ALTER TABLE `week_14` DISABLE KEYS */;
INSERT INTO `week_14` VALUES ('abradshaw',0,0,1,1),('akessler',1,0,1,0),('amcnair',0,0,0,0),('aparrish',0,1,0,0),('ascott',0,0,1,0),('asites',1,1,0,0),('awands',1,1,0,1),('bdahlgren',1,0,0,1),('bede',1,1,1,0),('bsnider',1,1,0,0),('bstewart',1,1,1,0),('bwhite',0,0,1,0),('cvalelo',1,0,0,0),('cwalrod',0,1,1,0),('dbass',0,0,1,0),('devans',0,0,1,1),('ebrenner',1,0,1,0),('efessler',0,0,0,0),('ekessel',1,1,1,1),('epowell',0,1,1,1),('erachell',1,0,0,0),('gjohnson',1,0,0,0),('gmcafee-myers',1,1,0,1),('gsapienza',0,1,0,0),('hdeaver',1,1,1,1),('hlara',0,0,1,1),('jcallahan',1,1,0,0),('jholm',0,1,0,0),('jjenkins',0,0,1,0),('jkessler',0,1,1,1),('jknifong',0,0,0,1),('jlentz',1,1,0,0),('jpatton',0,1,1,1),('jstovall',1,0,1,1),('kbocanegra',1,1,0,1),('kboyd',0,0,1,1),('kklingensmith',0,1,1,0),('lcanady',1,0,1,0),('ldavis',0,0,1,1),('ljames',0,0,0,0),('lschwarz',1,1,1,0),('mbay',1,0,1,1),('mboley',1,0,0,1),('mdavis',1,1,0,1),('mhatfield',0,1,0,1),('mhodge',0,0,1,1),('mpage',0,1,1,0),('ncorretjer',1,1,1,0),('ndaniel',0,1,0,1),('nrhodes',1,0,1,1),('odonaldson',1,0,0,1),('rbeckerman',0,1,1,0),('rgreen',1,1,1,1),('rmoffett',0,0,1,1),('rtindall',0,0,1,0),('schristy',1,0,0,0),('scrockett',0,0,0,1),('sdudenhoeffer',1,1,0,0),('snyquist',0,1,0,1),('soverby',0,1,0,0),('sscully',0,0,1,0),('stodd',0,1,1,0),('tshaw',0,1,0,1),('vcaballero',0,0,0,1),('zcambron',0,1,1,0),('zmontgomery',1,1,1,1),('﻿jarmington',1,0,1,1);
/*!40000 ALTER TABLE `week_14` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_15`
--

DROP TABLE IF EXISTS `week_15`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_15` (
  `username` varchar(20) NOT NULL,
  `llab` tinyint(1) NOT NULL,
  `tuesday` tinyint(1) NOT NULL,
  `thursday` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `week_15`
--

LOCK TABLES `week_15` WRITE;
/*!40000 ALTER TABLE `week_15` DISABLE KEYS */;
INSERT INTO `week_15` VALUES ('abradshaw',0,1,0,0),('akessler',0,0,0,1),('amcnair',0,0,0,1),('aparrish',1,0,0,0),('ascott',1,0,1,0),('asites',0,0,0,0),('awands',1,1,1,1),('bdahlgren',0,1,0,0),('bede',0,1,0,0),('bsnider',0,1,1,0),('bstewart',1,0,0,0),('bwhite',1,0,0,0),('cvalelo',0,1,0,1),('cwalrod',1,1,0,1),('dbass',1,0,0,0),('devans',0,0,1,1),('ebrenner',1,1,0,1),('efessler',0,0,1,1),('ekessel',1,0,1,0),('epowell',0,0,0,0),('erachell',1,1,1,0),('gjohnson',0,0,1,0),('gmcafee-myers',0,0,0,1),('gsapienza',0,1,0,1),('hdeaver',1,0,1,0),('hlara',1,0,0,1),('jcallahan',1,1,1,0),('jholm',0,0,1,1),('jjenkins',0,0,0,0),('jkessler',1,1,1,0),('jknifong',0,0,1,1),('jlentz',0,0,1,1),('jpatton',0,0,1,1),('jstovall',0,0,0,1),('kbocanegra',0,0,1,0),('kboyd',1,1,0,0),('kklingensmith',0,1,0,0),('lcanady',0,1,1,0),('ldavis',1,0,1,1),('ljames',1,0,1,0),('lschwarz',1,0,1,1),('mbay',0,0,0,1),('mboley',1,0,1,1),('mdavis',1,0,1,1),('mhatfield',1,0,0,1),('mhodge',1,1,1,0),('mpage',0,0,0,0),('ncorretjer',1,0,0,0),('ndaniel',0,1,0,0),('nrhodes',0,1,0,0),('odonaldson',0,1,1,1),('rbeckerman',0,0,0,1),('rgreen',0,0,0,0),('rmoffett',0,1,1,0),('rtindall',1,1,0,0),('schristy',1,0,1,1),('scrockett',0,0,1,1),('sdudenhoeffer',1,0,1,0),('snyquist',0,1,1,1),('soverby',0,0,0,0),('sscully',1,0,1,1),('stodd',1,1,1,0),('tshaw',0,1,0,1),('vcaballero',0,1,0,0),('zcambron',1,0,0,0),('zmontgomery',0,1,1,0),('﻿jarmington',0,1,1,1);
/*!40000 ALTER TABLE `week_15` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_16`
--

DROP TABLE IF EXISTS `week_16`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_16` (
  `username` varchar(20) NOT NULL,
  `llab` tinyint(1) NOT NULL,
  `tuesday` tinyint(1) NOT NULL,
  `thursday` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `week_16`
--

LOCK TABLES `week_16` WRITE;
/*!40000 ALTER TABLE `week_16` DISABLE KEYS */;
INSERT INTO `week_16` VALUES ('abradshaw',0,0,1,1),('akessler',0,1,0,1),('amcnair',1,0,0,0),('aparrish',1,0,0,0),('ascott',1,0,0,1),('asites',1,1,1,1),('awands',1,0,0,0),('bdahlgren',0,0,1,0),('bede',0,0,0,1),('bsnider',1,0,0,1),('bstewart',0,0,0,1),('bwhite',1,0,1,0),('cvalelo',0,0,0,0),('cwalrod',1,1,1,1),('dbass',1,0,1,0),('devans',0,0,0,0),('ebrenner',0,1,0,0),('efessler',1,1,0,0),('ekessel',1,1,1,1),('epowell',0,0,1,0),('erachell',0,0,0,0),('gjohnson',0,1,0,0),('gmcafee-myers',1,0,0,0),('gsapienza',1,1,1,0),('hdeaver',0,1,0,1),('hlara',1,1,1,1),('jcallahan',0,0,1,0),('jholm',0,1,0,0),('jjenkins',0,1,0,1),('jkessler',1,0,1,1),('jknifong',0,1,0,1),('jlentz',0,1,1,1),('jpatton',0,1,0,0),('jstovall',0,1,1,0),('kbocanegra',1,0,0,0),('kboyd',1,1,0,1),('kklingensmith',0,0,1,1),('lcanady',0,0,0,1),('ldavis',1,0,1,1),('ljames',1,0,1,1),('lschwarz',0,1,0,0),('mbay',0,1,0,0),('mboley',0,1,0,1),('mdavis',0,0,0,0),('mhatfield',0,1,0,1),('mhodge',1,0,0,1),('mpage',1,0,1,1),('ncorretjer',1,1,1,1),('ndaniel',1,1,0,0),('nrhodes',0,1,1,0),('odonaldson',0,0,1,0),('rbeckerman',0,1,1,0),('rgreen',0,0,0,0),('rmoffett',1,1,1,1),('rtindall',0,1,1,1),('schristy',0,0,0,0),('scrockett',0,1,1,0),('sdudenhoeffer',1,1,0,1),('snyquist',1,0,0,1),('soverby',0,0,1,1),('sscully',0,1,0,1),('stodd',1,0,0,0),('tshaw',0,1,1,0),('vcaballero',1,0,0,0),('zcambron',1,1,0,0),('zmontgomery',0,0,1,1),('﻿jarmington',1,1,0,1);
/*!40000 ALTER TABLE `week_16` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_2`
--

DROP TABLE IF EXISTS `week_2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_2` (
  `username` varchar(20) NOT NULL,
...
--
-- Dumping data for table `week_2`
--

LOCK TABLES `week_2` WRITE;
/*!40000 ALTER TABLE `week_2` DISABLE KEYS */;
INSERT INTO `week_2` VALUES ('abradshaw',1,1,1,1),('akessler',0,0,1,1),('amcnair',1,0,1,1),('aparrish',0,0,1,1),('ascott',0,0,1,1),('asites',0,0,0,1),('awands',1,0,0,0),('bdahlgren',1,1,1,1),('bede',1,0,0,0),('bsnider',1,1,1,1),('bstewart',1,1,0,0),('bwhite',0,1,0,1),('cvalelo',1,1,0,1),('cwalrod',0,1,1,1),('dbass',0,1,0,1),('devans',1,1,1,1),('ebrenner',1,0,1,1),('efessler',0,0,0,1),('ekessel',0,0,0,1),('epowell',1,1,1,1),('erachell',0,1,1,1),('gjohnson',0,1,0,0),('gmcafee-myers',0,0,0,0),('gsapienza',1,1,1,0),('hdeaver',0,1,0,1),('hlara',1,1,0,0),('jcallahan',1,1,0,1),('jholm',1,1,1,0),('jjenkins',0,1,1,1),('jkessler',1,0,0,0),('jknifong',0,1,0,0),('jlentz',1,1,0,0),('jpatton',1,1,0,1),('jstovall',1,0,0,0),('kbocanegra',1,0,1,0),('kboyd',1,0,1,1),('kklingensmith',0,0,1,0),('lcanady',1,0,1,1),('ldavis',1,1,0,0),('ljames',0,0,0,1),('lschwarz',1,1,1,0),('mbay',0,1,0,1),('mboley',0,0,0,1),('mdavis',0,1,1,1),('mhatfield',0,1,0,1),('mhodge',0,1,1,1),('mpage',1,1,0,0),('ncorretjer',1,0,0,0),('ndaniel',0,1,1,1),('nrhodes',0,1,1,1),('odonaldson',0,0,1,1),('rbeckerman',1,0,1,1),('rgreen',0,1,0,1),('rmoffett',0,1,1,1),('rtindall',0,0,1,1),('schristy',0,1,1,1),('scrockett',1,1,0,0),('sdudenhoeffer',1,1,0,1),('snyquist',1,0,1,1),('soverby',1,1,1,1),('sscully',1,1,0,0),('stodd',0,0,0,1),('tshaw',1,0,1,1),('vcaballero',1,0,0,1),('zcambron',1,1,1,1),('zmontgomery',1,1,0,1),('﻿jarmington',0,1,0,0);
/*!40000 ALTER TABLE `week_2` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_3`
--

DROP TABLE IF EXISTS `week_3`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_3` (
  `username` varchar(20) NOT NULL,
...
--
-- Dumping data for table `week_3`
--

LOCK TABLES `week_3` WRITE;
/*!40000 ALTER TABLE `week_3` DISABLE KEYS */;
INSERT INTO `week_3` VALUES ('abradshaw',0,0,0,0),('akessler',0,1,0,0),('amcnair',1,0,0,1),('aparrish',1,1,0,0),('ascott',1,1,1,1),('asites',0,0,1,1),('awands',1,0,0,1),('bdahlgren',1,0,0,0),('bede',0,1,0,0),('bsnider',0,1,1,1),('bstewart',0,1,0,0),('bwhite',0,0,1,0),('cvalelo',1,1,0,0),('cwalrod',0,0,1,0),('dbass',1,1,1,1),('devans',1,1,1,1),('ebrenner',1,0,1,1),('efessler',1,0,1,1),('ekessel',1,0,0,0),('epowell',0,1,1,1),('erachell',1,0,0,1),('gjohnson',1,1,1,1),('gmcafee-myers',0,1,1,1),('gsapienza',1,1,0,0),('hdeaver',1,0,0,0),('hlara',0,1,1,1),('jcallahan',0,0,1,0),('jholm',1,1,1,1),('jjenkins',0,1,1,0),('jkessler',0,1,1,1),('jknifong',0,1,1,1),('jlentz',0,1,1,1),('jpatton',0,1,0,0),('jstovall',1,1,0,1),('kbocanegra',1,1,0,1),('kboyd',1,1,0,1),('kklingensmith',1,1,0,1),('lcanady',1,1,0,0),('ldavis',0,1,0,1),('ljames',0,1,0,1),('lschwarz',1,1,1,1),('mbay',1,0,0,1),('mboley',1,0,0,1),('mdavis',0,0,0,0),('mhatfield',1,0,1,0),('mhodge',0,0,1,0),('mpage',1,0,1,1),('ncorretjer',0,1,1,0),('ndaniel',0,0,1,0),('nrhodes',0,1,0,1),('odonaldson',1,0,0,0),('rbeckerman',0,0,0,1),('rgreen',0,1,1,1),('rmoffett',0,0,0,1),('rtindall',1,0,1,1),('schristy',1,0,1,1),('scrockett',1,0,0,1),('sdudenhoeffer',0,0,1,0),('snyquist',1,0,1,0),('soverby',0,1,1,1),('sscully',0,1,0,1),('stodd',1,1,0,1),('tshaw',1,1,0,0),('vcaballero',0,0,1,0),('zcambron',1,0,1,0),('zmontgomery',1,1,0,0),('﻿jarmington',0,1,1,1);
/*!40000 ALTER TABLE `week_3` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_4`
--

DROP TABLE IF EXISTS `week_4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_4` (
  `username` varchar(20) NOT NULL,
...
--
-- Dumping data for table `week_4`
--

LOCK TABLES `week_4` WRITE;
/*!40000 ALTER TABLE `week_4` DISABLE KEYS */;
INSERT INTO `week_4` VALUES ('abradshaw',1,1,1,0),('akessler',0,1,0,1),('amcnair',1,1,1,0),('aparrish',0,0,0,1),('ascott',0,1,0,0),('asites',0,1,0,1),('awands',1,0,0,1),('bdahlgren',0,1,1,1),('bede',0,0,1,1),('bsnider',0,1,1,1),('bstewart',0,1,0,1),('bwhite',0,0,0,0),('cvalelo',0,1,0,1),('cwalrod',0,1,0,1),('dbass',1,0,1,0),('devans',0,0,0,1),('ebrenner',1,0,1,0),('efessler',0,0,0,1),('ekessel',1,0,0,0),('epowell',1,0,0,1),('erachell',1,0,1,1),('gjohnson',0,1,0,0),('gmcafee-myers',0,0,0,1),('gsapienza',0,1,1,0),('hdeaver',1,0,1,0),('hlara',0,0,0,0),('jcallahan',1,1,0,1),('jholm',0,1,1,0),('jjenkins',0,0,0,0),('jkessler',0,0,1,0),('jknifong',1,1,1,0),('jlentz',0,0,1,0),('jpatton',0,1,0,1),('jstovall',1,1,1,1),('kbocanegra',0,0,1,1),('kboyd',0,0,1,1),('kklingensmith',0,1,1,1),('lcanady',0,0,1,1),('ldavis',0,0,0,1),('ljames',1,1,1,1),('lschwarz',1,1,0,0),('mbay',0,1,1,1),('mboley',1,1,1,1),('mdavis',0,0,1,1),('mhatfield',0,0,0,1),('mhodge',1,1,0,0),('mpage',1,1,0,0),('ncorretjer',0,1,1,0),('ndaniel',1,1,0,1),('nrhodes',0,1,0,1),('odonaldson',1,0,1,0),('rbeckerman',1,0,0,1),('rgreen',0,1,1,1),('rmoffett',0,0,1,1),('rtindall',0,0,0,1),('schristy',0,0,1,0),('scrockett',1,1,0,0),('sdudenhoeffer',0,1,0,1),('snyquist',0,1,1,1),('soverby',0,0,1,1),('sscully',1,1,1,0),('stodd',0,1,1,1),('tshaw',0,1,0,1),('vcaballero',0,1,0,1),('zcambron',0,0,0,0),('zmontgomery',0,0,0,0),('﻿jarmington',1,0,1,0);
/*!40000 ALTER TABLE `week_4` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_5`
--

DROP TABLE IF EXISTS `week_5`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_5` (
  `username` varchar(20) NOT NULL,
...
--
-- Dumping data for table `week_5`
--

LOCK TABLES `week_5` WRITE;
/*!40000 ALTER TABLE `week_5` DISABLE KEYS */;
INSERT INTO `week_5` VALUES ('abradshaw',1,0,1,1),('akessler',0,1,0,0),('amcnair',0,0,1,0),('aparrish',1,1,0,1),('ascott',1,0,1,1),('asites',0,0,1,1),('awands',0,1,0,1),('bdahlgren',1,0,0,1),('bede',1,1,0,1),('bsnider',1,0,0,0),('bstewart',1,0,1,0),('bwhite',1,0,0,1),('cvalelo',0,1,0,1),('cwalrod',0,0,0,0),('dbass',0,0,0,0),('devans',0,0,0,0),('ebrenner',1,1,0,0),('efessler',0,1,0,1),('ekessel',1,0,1,1),('epowell',0,0,1,1),('erachell',1,1,1,0),('gjohnson',0,1,0,1),('gmcafee-myers',0,0,0,0),('gsapienza',0,1,0,1),('hdeaver',1,0,0,0),('hlara',1,1,0,1),('jcallahan',0,0,0,0),('jholm',0,1,0,1),('jjenkins',0,0,0,1),('jkessler',1,1,1,0),('jknifong',1,1,1,0),('jlentz',1,1,0,0),('jpatton',0,1,0,1),('jstovall',0,1,0,0),('kbocanegra',1,0,0,0),('kboyd',1,0,1,1),('kklingensmith',0,1,1,0),('lcanady',1,0,1,1),('ldavis',0,0,1,1),('ljames',1,0,1,1),('lschwarz',1,0,1,1),('mbay',1,0,0,0),('mboley',1,1,1,0),('mdavis',0,0,1,1),('mhatfield',1,1,0,0),('mhodge',0,1,0,1),('mpage',0,1,0,1),('ncorretjer',1,1,1,0),('ndaniel',1,1,0,0),('nrhodes',1,1,0,1),('odonaldson',0,0,0,0),('rbeckerman',1,0,1,1),('rgreen',1,1,1,0),('rmoffett',0,0,0,1),('rtindall',0,0,1,0),('schristy',0,1,1,1),('scrockett',0,1,0,1),('sdudenhoeffer',0,1,0,0),('snyquist',1,1,1,1),('soverby',0,0,0,1),('sscully',0,0,1,1),('stodd',1,0,0,0),('tshaw',0,0,0,0),('vcaballero',0,0,1,0),('zcambron',1,1,0,1),('zmontgomery',1,0,1,0),('﻿jarmington',1,0,0,1);
/*!40000 ALTER TABLE `week_5` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_6`
--

DROP TABLE IF EXISTS `week_6`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_6` (
  `username` varchar(20) NOT NULL,
...
--
-- Dumping data for table `week_6`
--

LOCK TABLES `week_6` WRITE;
/*!40000 ALTER TABLE `week_6` DISABLE KEYS */;
INSERT INTO `week_6` VALUES ('abradshaw',1,1,0,0),('akessler',1,0,1,1),('amcnair',0,1,1,0),('aparrish',0,0,0,0),('ascott',0,1,1,0),('asites',1,1,0,1),('awands',0,0,0,0),('bdahlgren',1,0,1,0),('bede',0,0,1,1),('bsnider',0,0,1,1),('bstewart',1,0,0,0),('bwhite',1,1,1,1),('cvalelo',1,1,0,1),('cwalrod',1,1,1,1),('dbass',0,0,0,1),('devans',0,1,1,0),('ebrenner',1,0,1,1),('efessler',0,1,1,0),('ekessel',0,1,1,0),('epowell',0,0,1,0),('erachell',0,1,1,1),('gjohnson',1,0,0,0),('gmcafee-myers',0,0,1,1),('gsapienza',1,1,0,0),('hdeaver',0,0,0,1),('hlara',0,1,1,1),('jcallahan',0,1,1,1),('jholm',0,0,1,1),('jjenkins',0,0,0,0),('jkessler',1,1,0,0),('jknifong',1,1,1,0),('jlentz',1,0,1,0),('jpatton',1,1,1,1),('jstovall',1,1,0,0),('kbocanegra',1,0,1,1),('kboyd',0,1,1,1),('kklingensmith',1,0,0,0),('lcanady',1,0,0,0),('ldavis',0,0,0,0),('ljames',1,0,1,0),('lschwarz',0,0,1,0),('mbay',0,0,1,0),('mboley',0,0,1,0),('mdavis',0,1,0,0),('mhatfield',1,1,0,0),('mhodge',1,1,1,0),('mpage',0,0,1,1),('ncorretjer',0,0,0,1),('ndaniel',0,0,0,1),('nrhodes',0,0,0,1),('odonaldson',0,1,0,1),('rbeckerman',1,0,0,0),('rgreen',0,1,1,1),('rmoffett',1,0,0,1),('rtindall',0,0,1,1),('schristy',1,0,0,0),('scrockett',0,1,0,1),('sdudenhoeffer',1,1,1,1),('snyquist',0,1,1,1),('soverby',1,1,1,1),('sscully',0,1,0,1),('stodd',0,0,1,0),('tshaw',1,0,1,1),('vcaballero',0,0,0,0),('zcambron',0,0,0,1),('zmontgomery',1,1,1,0),('﻿jarmington',1,0,1,1);
/*!40000 ALTER TABLE `week_6` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_7`
--

DROP TABLE IF EXISTS `week_7`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_7` (
  `username` varchar(20) NOT NULL,
...
--
-- Dumping data for table `week_7`
--

LOCK TABLES `week_7` WRITE;
/*!40000 ALTER TABLE `week_7` DISABLE KEYS */;
INSERT INTO `week_7` VALUES ('abradshaw',0,1,1,1),('akessler',0,1,1,1),('amcnair',1,1,0,0),('aparrish',0,0,0,0),('ascott',0,0,0,1),('asites',1,0,0,0),('awands',0,0,1,0),('bdahlgren',1,0,0,1),('bede',1,1,0,1),('bsnider',1,1,0,0),('bstewart',1,0,1,0),('bwhite',1,1,1,1),('cvalelo',1,0,0,0),('cwalrod',1,0,1,1),('dbass',1,0,1,1),('devans',0,0,0,1),('ebrenner',1,0,0,1),('efessler',0,0,0,0),('ekessel',0,1,1,1),('epowell',1,0,0,0),('erachell',1,0,1,1),('gjohnson',0,1,1,0),('gmcafee-myers',1,0,0,0),('gsapienza',1,1,1,0),('hdeaver',0,1,1,0),('hlara',1,1,0,1),('jcallahan',0,1,0,0),('jholm',1,1,0,1),('jjenkins',1,1,0,0),('jkessler',0,1,0,0),('jknifong',0,1,0,1),('jlentz',0,1,1,1),('jpatton',0,0,1,1),('jstovall',1,0,0,0),('kbocanegra',1,1,1,1),('kboyd',0,0,0,0),('kklingensmith',0,0,0,1),('lcanady',1,0,1,1),('ldavis',1,1,0,1),('ljames',0,0,1,1),('lschwarz',0,1,0,0),('mbay',1,1,0,0),('mboley',1,0,0,0),('mdavis',1,1,1,0),('mhatfield',0,0,1,1),('mhodge',1,0,1,0),('mpage',1,1,0,0),('ncorretjer',0,0,0,0),('ndaniel',1,0,0,0),('nrhodes',0,0,0,0),('odonaldson',1,0,0,0),('rbeckerman',0,1,0,1),('rgreen',0,1,0,1),('rmoffett',0,0,0,0),('rtindall',0,0,0,1),('schristy',1,1,1,1),('scrockett',1,0,0,0),('sdudenhoeffer',1,1,1,0),('snyquist',1,1,1,1),('soverby',1,0,1,1),('sscully',1,0,0,1),('stodd',0,0,1,1),('tshaw',1,0,1,0),('vcaballero',1,0,0,1),('zcambron',0,1,0,1),('zmontgomery',1,0,0,0),('﻿jarmington',0,1,1,1);
/*!40000 ALTER TABLE `week_7` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_8`
--

DROP TABLE IF EXISTS `week_8`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_8` (
  `username` varchar(20) NOT NULL,
...
--
-- Dumping data for table `week_8`
--

LOCK TABLES `week_8` WRITE;
/*!40000 ALTER TABLE `week_8` DISABLE KEYS */;
INSERT INTO `week_8` VALUES ('abradshaw',1,0,0,1),('akessler',0,1,1,1),('amcnair',0,0,0,0),('aparrish',0,0,0,1),('ascott',1,0,1,0),('asites',1,0,0,0),('awands',1,0,1,0),('bdahlgren',1,0,1,1),('bede',1,1,1,1),('bsnider',0,1,1,0),('bstewart',0,0,0,1),('bwhite',0,0,1,0),('cvalelo',0,0,1,1),('cwalrod',1,0,0,1),('dbass',0,0,1,1),('devans',1,0,0,1),('ebrenner',0,0,0,0),('efessler',0,1,0,0),('ekessel',0,1,0,0),('epowell',1,0,1,1),('erachell',0,1,0,0),('gjohnson',1,0,1,1),('gmcafee-myers',1,0,0,0),('gsapienza',1,0,0,1),('hdeaver',1,1,0,1),('hlara',1,0,1,1),('jcallahan',0,1,0,1),('jholm',1,1,1,1),('jjenkins',1,0,0,1),('jkessler',1,0,1,1),('jknifong',1,0,0,0),('jlentz',0,1,0,1),('jpatton',0,1,0,1),('jstovall',1,0,1,0),('kbocanegra',0,0,1,1),('kboyd',0,0,1,1),('kklingensmith',1,1,1,1),('lcanady',1,1,1,1),('ldavis',0,1,0,0),('ljames',0,0,1,1),('lschwarz',1,0,0,0),('mbay',1,1,0,0),('mboley',0,1,1,0),('mdavis',0,1,0,0),('mhatfield',1,1,0,0),('mhodge',0,0,0,1),('mpage',0,0,1,0),('ncorretjer',1,1,1,0),('ndaniel',0,0,0,1),('nrhodes',1,0,0,1),('odonaldson',0,1,0,1),('rbeckerman',1,0,0,0),('rgreen',1,0,0,0),('rmoffett',1,1,0,1),('rtindall',1,1,1,1),('schristy',1,1,0,0),('scrockett',0,1,0,1),('sdudenhoeffer',1,0,0,1),('snyquist',0,1,1,1),('soverby',1,1,1,0),('sscully',0,1,0,0),('stodd',1,1,1,1),('tshaw',1,0,1,0),('vcaballero',0,1,0,0),('zcambron',0,1,1,1),('zmontgomery',1,0,1,0),('﻿jarmington',1,0,0,1);
/*!40000 ALTER TABLE `week_8` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `week_9`
--

DROP TABLE IF EXISTS `week_9`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `week_9` (
  `username` varchar(20) NOT NULL,
...
--
-- Dumping data for table `week_9`
--

LOCK TABLES `week_9` WRITE;
/*!40000 ALTER TABLE `week_9` DISABLE KEYS */;
INSERT INTO `week_9` VALUES ('abradshaw',0,1,0,0),('akessler',1,0,0,1),('amcnair',1,1,0,1),('aparrish',0,0,1,1),('ascott',1,1,1,1),('asites',0,0,0,0),('awands',0,1,0,1),('bdahlgren',1,0,1,0),('bede',0,1,1,0),('bsnider',0,1,1,1),('bstewart',1,0,1,1),('bwhite',0,0,0,1),('cvalelo',0,1,0,0),('cwalrod',1,1,1,0),('dbass',1,1,1,0),('devans',1,1,0,1),('ebrenner',0,0,1,0),('efessler',0,1,0,0),('ekessel',0,1,0,0),('epowell',1,1,0,0),('erachell',0,0,0,0),('gjohnson',1,0,0,0),('gmcafee-myers',1,0,0,1),('gsapienza',1,1,1,1),('hdeaver',0,0,0,0),('hlara',0,1,1,1),('jcallahan',0,0,1,1),('jholm',1,0,1,1),('jjenkins',1,0,0,1),('jkessler',0,0,0,0),('jknifong',1,1,1,0),('jlentz',0,0,1,0),('jpatton',1,0,1,1),('jstovall',0,0,1,0),('kbocanegra',0,0,0,0),('kboyd',1,1,1,0),('kklingensmith',1,0,0,0),('lcanady',0,0,0,0),('ldavis',0,0,0,1),('ljames',1,1,1,0),('lschwarz',1,0,0,0),('mbay',0,1,0,1),('mboley',1,1,1,0),('mdavis',0,0,1,1),('mhatfield',0,1,1,1),('mhodge',1,1,1,0),('mpage',0,1,0,1),('ncorretjer',0,1,0,0),('ndaniel',0,1,0,0),('nrhodes',1,1,0,1),('odonaldson',1,0,1,1),('rbeckerman',0,1,1,0),('rgreen',1,0,0,1),('rmoffett',1,1,0,1),('rtindall',1,0,1,1),('schristy',1,1,1,1),('scrockett',1,1,1,0),('sdudenhoeffer',1,0,0,1),('snyquist',0,0,1,1),('soverby',1,0,1,0),('sscully',1,0,0,0),('stodd',0,1,0,0),('tshaw',0,0,1,1),('vcaballero',1,1,0,0),('zcambron',1,1,0,0),('zmontgomery',1,1,0,0),('﻿jarmington',0,1,0,1);
/*!40000 ALTER TABLE `week_9` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-21 19:40:32
